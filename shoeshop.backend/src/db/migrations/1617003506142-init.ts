...
export class init1617003506142 implements MigrationInterface {
    name = 'init1617003506142'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("created_at" datetime NOT NULL CONSTRAINT "DF_e53d92730ba8bd3bd87e73b076b" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_faa05c6206e7196b91251712625" DEFAULT getdate(), "id" int NOT NULL IDENTITY(1,1), "status" char(50) NOT NULL, "code" char(20) NOT NULL, "reason" nvarchar(100) NOT NULL, "description" ntext NOT NULL, "price" int NOT NULL, "payment_method" char(20) NOT NULL, "name" nvarchar(30) NOT NULL, "phone" char(20) NOT NULL, "address" ntext NOT NULL, "cityId" int, "districtId" int, "wardId" int, "clientId" int, "carrierId" int, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
