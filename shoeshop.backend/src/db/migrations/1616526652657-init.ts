...
export class init1616526652657 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "category" ("created_at" datetime NOT NULL CONSTRAINT "DF_dff2bd18e8bb11a0300d4a624c9" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_e302377d50550b1b13853825736" DEFAULT getdate(), "id" int NOT NULL, "name" nvarchar(30) NOT NULL, "image" char(150) NOT NULL, "slug" char(30) NOT NULL, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "city" ("created_at" datetime NOT NULL CONSTRAINT "DF_60ff27bbe4002d0da0da7801087" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_30ed5429ba71049444b64174bdf" DEFAULT getdate(), "id" int NOT NULL, "code" int NOT NULL, "name" nvarchar(50) NOT NULL, "is_active" int NOT NULL, CONSTRAINT "UQ_b94ae715aad0d13e62f585ff11b" UNIQUE ("code"), CONSTRAINT "PK_b222f51ce26f7e5ca86944a6739" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "client" ("created_at" datetime NOT NULL CONSTRAINT "DF_9841844ab2a315a156e3ebd1aa2" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_60c73ce2df2afd0c95772e50f97" DEFAULT getdate(), "id" int NOT NULL, "users_id" int NOT NULL, "gender" char(10) NOT NULL, "avatar" char(150) NOT NULL, "dob" char(30) NOT NULL, CONSTRAINT "UQ_fe74bfd4d01077395ee4204b553" UNIQUE ("users_id"), CONSTRAINT "PK_96da49381769303a6515a8785c7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "color" ("created_at" datetime NOT NULL CONSTRAINT "DF_051b1d1b086448bd29602a41a5f" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_b53eaf94eaeaf84e6b1cf2d770a" DEFAULT getdate(), "id" int NOT NULL, "name" nvarchar(50) NOT NULL, CONSTRAINT "PK_d15e531d60a550fbf23e1832343" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "delivery_address" ("created_at" datetime NOT NULL CONSTRAINT "DF_1b14b93ed0ef3813e9a40fb83e4" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_f4083f8efc5b0be348c71d89597" DEFAULT getdate(), "id" int NOT NULL, "full_name" nvarchar(100) NOT NULL, "phone" char(20) NOT NULL, "address" ntext NOT NULL, "is_default" int NOT NULL CONSTRAINT "DF_837acc73285d1ffc15acbf0b2ab" DEFAULT 0, "clientId" int, "cityId" int, "districtId" int, "wardId" int, CONSTRAINT "PK_00581098daef1f881bb3d17a0cd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "district" ("created_at" datetime NOT NULL CONSTRAINT "DF_cf89c2c860d2c4398d9f35c5dd3" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_671fa8036158877c6091ed9cac6" DEFAULT getdate(), "id" int NOT NULL, "city_id" int NOT NULL, "code" int NOT NULL, "name" nvarchar(50) NOT NULL, "is_active" int NOT NULL, CONSTRAINT "UQ_fbfe5cb0d22c2be8c9a9fff5b6b" UNIQUE ("code"), CONSTRAINT "PK_ee5cb6fd5223164bb87ea693f1e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "material" ("created_at" datetime NOT NULL CONSTRAINT "DF_626f5350173539ba1cf2663f9b2" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_2dc2eec957274b279ee88143251" DEFAULT getdate(), "id" int NOT NULL, "name" nvarchar(30) NOT NULL, CONSTRAINT "PK_0343d0d577f3effc2054cbaca7f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "origin" ("created_at" datetime NOT NULL CONSTRAINT "DF_b84376b2af7b98c0e633696a6c1" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_efd4f9dd96fb0c96d7149ab6c2e" DEFAULT getdate(), "id" int NOT NULL, "name" nvarchar(30) NOT NULL, CONSTRAINT "PK_f6e2cbfad6d4ed0a9cb9bb8de95" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_image" ("created_at" datetime NOT NULL CONSTRAINT "DF_c6e82cb9f5ce1267829e61da6ed" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_f3f4e069c153c6e9530355f1216" DEFAULT getdate(), "id" int NOT NULL, "product_id" int NOT NULL, "url" char(150) NOT NULL, CONSTRAINT "PK_99d98a80f57857d51b5f63c8240" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_video" ("created_at" datetime NOT NULL CONSTRAINT "DF_1831c81ce12d8df9dc335615223" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_25d39daf3d68aebca76172d37fa" DEFAULT getdate(), "id" int NOT NULL, "product_id" int NOT NULL, "url" char(150) NOT NULL, "thumbnail" char(150) NOT NULL, "youtube_url" char(150) NOT NULL, CONSTRAINT "PK_9769e5e31c1906083b7d2502da3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product" ("created_at" datetime NOT NULL CONSTRAINT "DF_91b4f645f7fe267179af692bf09" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_4a5ee402c3f5d53ce5c768da158" DEFAULT getdate(), "id" int NOT NULL, "code" char(20) NOT NULL, "name" nvarchar(100) NOT NULL, "address" ntext NOT NULL, "price" int NOT NULL, "discount_price" int NOT NULL, "current_price" int NOT NULL, "is_special" int NOT NULL, "is_sell_well" int NOT NULL, "status" int NOT NULL CONSTRAINT "DF_01286e06a0554cbb19375f0178c" DEFAULT 1, "thumbnail" char(150) NOT NULL, "slug" char(100) NOT NULL, "short_description" nvarchar(150) NOT NULL, "description" ntext NOT NULL, "body_detail" nvarchar(150) NOT NULL, "sole_detail" nvarchar(150) NOT NULL, "priority" int NOT NULL, "quantity" int NOT NULL, "vat" int NOT NULL, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "size" ("created_at" datetime NOT NULL CONSTRAINT "DF_04f681ab6e96d4e8632331e4a06" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_4db51187cc2cac70b5778c1e44a" DEFAULT getdate(), "id" int NOT NULL, "name" int NOT NULL, CONSTRAINT "PK_66e3a0111d969aa0e5f73855c7a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tag" ("created_at" datetime NOT NULL CONSTRAINT "DF_7561a113607b9a3804c895442aa" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_12e318242b90834fb3b94c5654d" DEFAULT getdate(), "id" int NOT NULL, "code" char(20) NOT NULL, "name" nvarchar(30) NOT NULL, "status" int NOT NULL CONSTRAINT "DF_261bd1495d4d3e29802752471fd" DEFAULT 1, CONSTRAINT "PK_8e4052373c579afc1471f526760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ward" ("created_at" datetime NOT NULL CONSTRAINT "DF_85c34eace8bab6759e3fcdcf84a" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_fb511c2b3b3cf5b2c7629f60abe" DEFAULT getdate(), "id" int NOT NULL, "district_id" int NOT NULL, "code" int NOT NULL, "name" nvarchar(50) NOT NULL, "is_active" int NOT NULL, CONSTRAINT "UQ_14bd787455693efede59d248a7d" UNIQUE ("code"), CONSTRAINT "PK_e6725fa4a50e449c4352d2230e1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cart_item" ("created_at" datetime NOT NULL CONSTRAINT "DF_05cd6882ee1cb14b09f7986d55e" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_9c81cb1a0550b62ec99cb93b7f8" DEFAULT getdate(), "id" int NOT NULL, "cart_id" int NOT NULL, "amount" int NOT NULL, "productId" int, CONSTRAINT "PK_bd94725aa84f8cf37632bcde997" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "flash_sale" ("created_at" datetime NOT NULL CONSTRAINT "DF_ab19ce01ce48b58f4d8bc7104eb" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_c9b8fcda34e63a76a185d9c3693" DEFAULT getdate(), "id" int NOT NULL, "title" nvarchar(100) NOT NULL, "start_date" char(30) NOT NULL, "end_date" char(30) NOT NULL, "status" int NOT NULL CONSTRAINT "DF_68d983672d45a617b6fbbc0423f" DEFAULT 1, CONSTRAINT "PK_0ca3636f18f85dce0d2b800a7fb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "flash_sale_item" ("created_at" datetime NOT NULL CONSTRAINT "DF_e6e1a9b0a30f5f6daf34392caf3" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_458a333b95b05982b3a60832963" DEFAULT getdate(), "id" int NOT NULL, "flash_sale_id" int NOT NULL, "sale_price" int NOT NULL, "quantity" int NOT NULL, "sold_quantity" int NOT NULL, "product_id" int, CONSTRAINT "PK_2ac37fab8feb8cdb1a2d5649651" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "order" ("created_at" datetime NOT NULL CONSTRAINT "DF_e53d92730ba8bd3bd87e73b076b" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_faa05c6206e7196b91251712625" DEFAULT getdate(), "id" int NOT NULL, "client_id" int NOT NULL, "status" int NOT NULL CONSTRAINT "DF_7a9573d6a1fb982772a91233205" DEFAULT 1, "reason" nvarchar(100) NOT NULL, "description" ntext NOT NULL, "price" int NOT NULL, "shipping_fee" int NOT NULL, "payment_method" char(20) NOT NULL, "name" nvarchar(30) NOT NULL, "phone" char(20) NOT NULL, "address" ntext NOT NULL, "wardId" int NOT NULL, "districtId" int NOT NULL, "cityId" int NOT NULL, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "blog" ("created_at" datetime NOT NULL CONSTRAINT "DF_d1a5ca9d3724c305b6694df08b1" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_b28774f0f9272aee03790561374" DEFAULT getdate(), "id" int NOT NULL, "title" nvarchar(150) NOT NULL, "status" int NOT NULL CONSTRAINT "DF_e9da73f0ea0d7f197aa7884e1aa" DEFAULT 1, "thumbnail" char(150) NOT NULL, "short_description" nvarchar(150) NOT NULL, "description" ntext NOT NULL, "slug" char(100) NOT NULL, "image" char(150) NOT NULL, CONSTRAINT "PK_85c6532ad065a448e9de7638571" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "blog_category" ("created_at" datetime NOT NULL CONSTRAINT "DF_982e13e125062efd6551112b1a8" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_46d10068aa404ec617abec558cc" DEFAULT getdate(), "id" int NOT NULL, "name" nvarchar(50) NOT NULL, "slug" char(50) NOT NULL, CONSTRAINT "PK_32b67ddf344608b5c2fb95bc90c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cart" ("created_at" datetime NOT NULL CONSTRAINT "DF_318fef55b3acc61bc8083ffe6ba" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_7647c6e6b918b92d0d5e7253b43" DEFAULT getdate(), "id" int NOT NULL, "clientId" int, CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "voucher_code" ("created_at" datetime NOT NULL CONSTRAINT "DF_e1d292ceb92e1b80c15c1f56d9d" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_1aa780bf85fb64809cbe70be648" DEFAULT getdate(), "id" int NOT NULL, "voucher_id" int NOT NULL, "code" char(30) NOT NULL, "status" int NOT NULL CONSTRAINT "DF_db0722d9dede46fae977208dfa0" DEFAULT 1, "is_used" int NOT NULL, CONSTRAINT "PK_ee60c59dedf99dfc18553762034" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "voucher" ("created_at" datetime NOT NULL CONSTRAINT "DF_7a511bf6a8227ede24395560d77" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_64f80f5d56bb56e9c986664053c" DEFAULT getdate(), "id" int NOT NULL, "title" varchar(50) NOT NULL, "start_date" char(30) NOT NULL, "end_date" char(30) NOT NULL, "percent_discount" int NOT NULL, "amount" int NOT NULL, "max_amount" int NOT NULL, "status" int NOT NULL CONSTRAINT "DF_cd7f3d24f8670b352454de63f26" DEFAULT 1, "quantity" int NOT NULL, "require_max_price" int NOT NULL, "require_min_price" int NOT NULL, CONSTRAINT "PK_677ae75f380e81c2f103a57ffaf" PRIMARY KEY ("id"))`);
