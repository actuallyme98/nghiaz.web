...
export class init1617532770124 implements MigrationInterface {
    name = 'init1617532770124'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cart_item" ("created_at" datetime NOT NULL CONSTRAINT "DF_05cd6882ee1cb14b09f7986d55e" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_9c81cb1a0550b62ec99cb93b7f8" DEFAULT getdate(), "id" int NOT NULL IDENTITY(1,1), "amount" int NOT NULL, "productId" int, "cartId" int, CONSTRAINT "PK_bd94725aa84f8cf37632bcde997" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "order" ("created_at" datetime NOT NULL CONSTRAINT "DF_e53d92730ba8bd3bd87e73b076b" DEFAULT getdate(), "updated_at" datetime NOT NULL CONSTRAINT "DF_faa05c6206e7196b91251712625" DEFAULT getdate(), "id" int NOT NULL IDENTITY(1,1), "status" char(50) NOT NULL, "code" char(20) NOT NULL, "reason" nvarchar(100) NOT NULL, "description" ntext NOT NULL, "discountPrice" int NOT NULL CONSTRAINT "DF_fa68dd905d7499b04e981a2335e" DEFAULT 0, "price" int NOT NULL, "payment_method" char(20) NOT NULL, "name" nvarchar(30) NOT NULL, "phone" char(20) NOT NULL, "address" ntext NOT NULL, "cityId" int, "districtId" int, "wardId" int, "clientId" int, "carrierId" int, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
